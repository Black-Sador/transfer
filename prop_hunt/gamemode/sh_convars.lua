...
local donation_message = CreateConVar("ph_sv_enable_donation_message", "1", { FCVAR_SERVER_CAN_EXECUTE, FCVAR_REPLICATED, FCVAR_ARCHIVE, FCVAR_NOTIFY }, "Enable a support message for the Prop Hunt: Enhanced gamemode. It's okay if you want to disable this :)")P