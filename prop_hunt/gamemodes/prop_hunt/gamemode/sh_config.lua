...
CreateConVar("prophunt_gametime", "30")
GAME_TIME = GetConVar("prophunt_gametime"):GetInt()


// Number of seconds hunters are blinded/locked at the beginning of the map (Default: 30)
CreateConVar("prophunt_hunter_blindtime","30")
HUNTER_BLINDLOCK_TIME = GetConVar("prophunt_hunter_blindtime"):GetInt()
...
CreateConVar("prophunt_kill_hpgive","20")
HUNTER_KILL_BONUS = GetConVar("prophunt_kill_hpgive"):GetInt()
